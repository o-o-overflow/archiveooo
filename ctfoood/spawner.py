...
runcmd:
 ...
 - echo 'iptables -I OUTPUT -d "{player_ip}" -j DROP && iptables -I INPUT -d "{player_ip}" -j DROP && iptables -P FORWARD DROP && iptables -F DOCKER && iptables -F FORWARD' | at now + 25 minutes
